...
public abstract class AdListHelper {
	...
	// Читает данные объявлениях из файла хранилища и формирует на их
	// основеобъект AdList.
	public static AdList readAdList(ServletContext context) {
		try {
			...
			// Если возникли проблемы с чтением из файла, возвращаем пустой
			// список
			return new AdList();
		}
	}
